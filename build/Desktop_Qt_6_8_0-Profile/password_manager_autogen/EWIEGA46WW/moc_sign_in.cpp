...
constexpr auto qt_meta_stringdata_CLASSsign_inENDCLASS = QtMocHelpers::stringData(
    "sign_in",
    "on_pushButton_si_sign_up_clicked",
    "",
    "on_pushButton_si_sign_in_clicked"
);
...
Q_CONSTINIT const QMetaObject sign_in::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSsign_inENDCLASS_t,
        ...
        // method 'on_pushButton_si_sign_up_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_pushButton_si_sign_in_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void sign_in::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_pushButton_si_sign_up_clicked(); break;
        case 1: _t->on_pushButton_si_sign_in_clicked(); break;
        default: ;
        }
    }
    (void)_a;
